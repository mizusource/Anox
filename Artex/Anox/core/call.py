        ...
        try:
            ...
            if get.status == "banned" or get.status == "kicked":
                try:
                    ...
                    raise AssistantErr(
                        _["call_2"].format(userbot.id, userbot.mention, userbot.username),
                    )
            ...
            if chat.username:
                ...
                try:
                    ...
                    await m.edit_text(_["call_6"].format(userbot.mention))
                except UserAlreadyParticipant:
                    pass
                except Exception as e:
                    raise AssistantErr(_["call_3"].format(e))
    ...
    async def join_call(
        ...
        try:
            ...
            try:
                ...
                raise AssistantErr(
                    "◍ قم بفتح الكول اولا فى الجروب\n√"
                )
        except AlreadyJoinedError:
            raise AssistantErr(
                "**حدث خطأ ما**\n\nقم بقفل المحادثه الصوتيه و فتحها ثم قم بكتابة /restart\nاو تواصل مع المطور -> @X1_ID"
            )
            ...
            if "live_" in queued:
                ...
                run = await app.send_photo(
                    ...
                    caption=_["stream_1"].format(
                        title[:70],
                        f"https://t.me/UBDDBOT?start=info_{videoid}",
                        chat_id,
                        check[0]["dur"],
                        user,
                    ),
